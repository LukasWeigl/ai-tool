  ...
  return (
    <>
      ...
      <div className="px-4 lg:px-8">
        <div>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="ounded-lg border w-full p-4 px-3 md:px-6 focus-whitin:shadow-sm grid grid-cols-12 gap-2">
                <FormField
                name = "prompt"
                render = {({ field }) => (
